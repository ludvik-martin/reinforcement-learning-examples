...
class ActorCriticHyperoptTest(TestCase):
    ...
    def _experiment(self, env, log_dir):
        ...
        def _experiment_impl(args):
            ...
            with writer.as_default():
                ...
                reinforce = ActorCriticNetwork(env, alpha=alpha, alpha_decay=alpha_decay, gamma=gamma, init_epsilon=init_epsilon, min_epsilon=0.0,
